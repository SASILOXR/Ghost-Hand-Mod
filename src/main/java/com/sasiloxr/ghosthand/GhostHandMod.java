...
@Mod(
    modid = GhostHandMod.MODID,
    name = GhostHandMod.NAME,
    version = GhostHandMod.VERSION,
    acceptedMinecraftVersions = "1.8.9")
public class GhostHandMod {
  public static final String MODID = "NoMouseOver";
  public static final String NAME = "NoMouseOver";
